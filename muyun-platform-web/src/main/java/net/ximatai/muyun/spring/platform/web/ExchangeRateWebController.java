...
@RestController
@PlatformStaticModule(application = net.ximatai.muyun.spring.platform.web.PlatformApplication.class, alias = ExchangeRateService.MODULE_ALIAS, title = "平台汇率", webScope = PlatformStaticModule.WebScope.CUSTOM)
