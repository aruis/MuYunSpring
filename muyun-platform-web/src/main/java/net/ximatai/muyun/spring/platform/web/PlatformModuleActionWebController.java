...
@RestController
@PlatformStaticModule(application = net.ximatai.muyun.spring.platform.web.PlatformApplication.class, alias = PlatformModuleActionService.MODULE_ALIAS, title = "平台模块动作",
