...
@PlatformStaticModule(application = net.ximatai.muyun.spring.platform.application.PlatformApplication.class, alias = MetadataFieldService.MODULE_ALIAS, title = "平台元数据字段")
