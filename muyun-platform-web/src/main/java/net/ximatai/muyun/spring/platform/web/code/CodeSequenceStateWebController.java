...
@RestController
@PlatformStaticModule(application = net.ximatai.muyun.spring.platform.web.PlatformApplication.class, alias = CodeSequenceStateService.MODULE_ALIAS, title = "编码序列状态", webScope = PlatformStaticModule.WebScope.CUSTOM)
