...
@PlatformStaticModule(application = net.ximatai.muyun.spring.platform.application.PlatformApplication.class, alias = PlatformUiConfigFieldService.MODULE_ALIAS,
        title = "平台 UI 字段配置")
