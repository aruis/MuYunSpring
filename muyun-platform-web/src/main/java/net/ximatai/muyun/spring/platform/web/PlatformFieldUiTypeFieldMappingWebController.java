...
@PlatformStaticModule(application = net.ximatai.muyun.spring.platform.application.PlatformApplication.class, alias = PlatformFieldUiTypeFieldMappingService.MODULE_ALIAS,
