...
@PlatformStaticModule(application = net.ximatai.muyun.spring.platform.application.PlatformApplication.class, alias = ModuleMetadataFieldAffectService.MODULE_ALIAS,
        title = "平台模块字段引用回填")
