...
@RestController
@PlatformStaticModule(application = net.ximatai.muyun.spring.platform.web.PlatformApplication.class, alias = MetadataFieldReferenceConfigService.MODULE_ALIAS,
