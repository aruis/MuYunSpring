...
@PlatformStaticModule(application = net.ximatai.muyun.spring.platform.application.PlatformApplication.class, alias = PlatformFieldUiTypeAttributeService.MODULE_ALIAS,
        title = "平台字段 UI 类型属性")
