...
@PlatformStaticModule(application = net.ximatai.muyun.spring.platform.application.PlatformApplication.class, alias = RecordGenerationRuleService.MODULE_ALIAS,
        title = "平台生单规则")
