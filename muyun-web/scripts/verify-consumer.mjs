...
try {
  ...
  execFileSync('npm', ['ci'], { cwd: temporaryExampleRoot, stdio: 'inherit' });
  ...
  execFileSync('tar', ['-xzf', tarball, '--strip-components=1', '-C', installedPackageRoot], {
  ...
  execFileSync('npm', ['run', 'build'], { cwd: temporaryExampleRoot, stdio: 'inherit' });
} finally {
