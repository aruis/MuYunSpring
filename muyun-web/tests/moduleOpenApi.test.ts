...
test('recognizes the API catalog route independently from a module document route', () => {
...
test('forwards the current session only to trusted OpenAPI request origins', async () => {
...
test('uses the configured backend origin for interactive OpenAPI calls', () => {
