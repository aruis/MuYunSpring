...
} from '../src/platform-components/fileTransferUpload.ts';

test('file transfer unwraps the conventional storage response envelope without coupling to a storage DTO', () => {
...
test('file transfer lifecycle updates the rendered item through completed after storage and business confirmation', async () => {
