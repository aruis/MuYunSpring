...
} from '../src/views/moduleManagementState.ts';

test('module management draft stays inside the selected application', () => {
...
test('module management normalizer preserves standard fields and clears inactive entry values', () => {
...
test('module management normalizer keeps only the entry value required by the selected entry type', () => {
