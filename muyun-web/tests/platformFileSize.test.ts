...
import { formatPlatformFileSize } from '../src/platform-components/platformFileSize.ts';

test('platform file size uses stable binary units with at most one decimal place', () => {
...
test('platform file size preserves exact bytes in tooltip and has stable empty fallback', () => {
