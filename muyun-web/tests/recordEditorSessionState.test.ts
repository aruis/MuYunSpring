...
} from '../src/platform-components/recordEditorSessionState.ts';
...
test('record editor session marks external changes only for the editing selected record', () => {
  const session = createRecordEditorSessionState<DemoRecord, 'view' | 'edit' | 'create'>({
    viewMode: 'view',
    createMode: 'create',
    editMode: 'edit',
...
test('record editor session keeps external change marker while refreshing selected record', () => {
  const session = createRecordEditorSessionState<DemoRecord, 'view' | 'edit' | 'create'>({
    viewMode: 'view',
    createMode: 'create',
    editMode: 'edit',
...
test('record editor session clears external change marker on explicit editor transitions', () => {
  const session = createRecordEditorSessionState<DemoRecord, 'view' | 'edit' | 'create'>({
    viewMode: 'view',
    createMode: 'create',
    editMode: 'edit',
...
test('record editor session supports custom external change record identity', () => {
...
test('record editor session applies matching data changes as external changes', () => {
  const session = createRecordEditorSessionState<DemoRecord, 'view' | 'edit' | 'create'>({
    viewMode: 'view',
    createMode: 'create',
    editMode: 'edit',
