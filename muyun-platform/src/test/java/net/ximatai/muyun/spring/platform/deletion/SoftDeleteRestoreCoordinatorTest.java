...
class SoftDeleteRestoreCoordinatorTest {
    ...
    void shouldWriteRestoreOperationAndLinkedEntriesForWholeSourceTree() {
        ...
        RestoreReport report = new SoftDeleteRestoreCoordinator(logService, List.of(tenant, application))
    ...
    void shouldAuditFailedRootAndSkippedDescendants() {
        ...
        RestoreReport report = new SoftDeleteRestoreCoordinator(logService, List.of(failingTenant, application))
                .restore(source.operationId());
