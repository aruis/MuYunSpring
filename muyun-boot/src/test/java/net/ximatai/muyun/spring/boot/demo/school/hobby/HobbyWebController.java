...
import net.ximatai.muyun.spring.boot.web.TreeWebProjectionPolicy;
...
public class HobbyWebController extends WebSupport<HobbyService>
        ...
        TreeWebProjectionPolicy<Hobby, HobbyService> {
    // TreeWebProjectionPolicy 只表达 HTTP 投影策略；树查询、移动和校验仍由 HobbyService 的 Ability 执行。
}
