...
@RestController
@PlatformStaticModule(application = net.ximatai.muyun.spring.boot.platform.PlatformApplication.class, alias = "platform.low_code_governance", title = "平台低代码治理", webScope = PlatformStaticModule.WebScope.CUSTOM)
