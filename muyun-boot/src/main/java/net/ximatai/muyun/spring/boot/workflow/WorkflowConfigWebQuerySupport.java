...
final class WorkflowConfigWebQuerySupport {
    private WorkflowConfigWebQuerySupport() {
    }
    ...
    private static Sort sort(WebSort sort, Set<String> allowedFields) {
        String field = requireAllowedField(sort.field(), allowedFields, "workflow config sort");
