...
public class PlatformFieldUiTypeFieldMappingWebController
    ...
    private static final Set<String> QUERY_FIELDS = Set.of(
            "id", "fieldUiTypeAlias", "sourceKey", "title", "sortOrder", "createdAt", "updatedAt");
    ...
    protected Sort[] querySorts(WebQueryRequest request) {
        return PlatformConfigWebQuerySupport.sorts(request, QUERY_FIELDS, Sort.asc("sortOrder"), Sort.asc("sourceKey"));
    }
