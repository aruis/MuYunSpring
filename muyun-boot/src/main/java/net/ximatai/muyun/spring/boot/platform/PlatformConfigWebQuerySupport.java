...
final class PlatformConfigWebQuerySupport {
    private PlatformConfigWebQuerySupport() {
    }
    ...
    private static Sort sort(WebSort sort, Set<String> allowedFields) {
        String field = requireAllowedField(sort.field(), allowedFields, "platform config sort");
