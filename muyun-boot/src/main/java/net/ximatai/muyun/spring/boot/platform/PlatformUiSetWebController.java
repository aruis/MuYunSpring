...
@RestController
@PlatformStaticModule(application = net.ximatai.muyun.spring.boot.platform.PlatformApplication.class, alias = PlatformUiSetService.MODULE_ALIAS, title = "平台 UI 配置集",
